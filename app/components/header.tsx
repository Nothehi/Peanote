...
export default function Header({name, level, avatar}: Props) {
	return (
		<header className="flex flex-row items-center justify-start w-full p-4 bg-cherry-800 rounded-b-4xl">
